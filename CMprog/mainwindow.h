...
private:
    ...
    QVector< QString >lebelObjName;
    QVector< QString >lebelRegName;
    QVector< QString >lebelXName;
    QVector< QString >lebelGName;
    ...
    QVector< MyLineEdit* > linesObjValue;
    QVector< MyLineEdit* > linesRegValue;
    QVector< MyLineEdit* > linesXValue;
    QVector< MyLineEdit* > linesGValue;
    //
    //QMap<int, double> SValue;//значения первого столбика для формул
    //QMap<int, double> AValue;//значения второго столбика для формул

    QMap<QString, double> UserValue;//введенные пользователем значения для формул
